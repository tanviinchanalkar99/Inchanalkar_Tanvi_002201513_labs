...
public class CreateNewProductJPanel extends javax.swing.JPanel {
    ...
    private void btnAddActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnAddActionPerformed
        ...
        JOptionPane.showMessageDialog(null, "Please enter a valid numeric value for Product Price", "Error", JOptionPane.ERROR_MESSAGE);
        return;
    }

    if (!txtAvailability.getText().matches("^\\d+$")) {
        JOptionPane.showMessageDialog(null, "Please enter a valid numeric value for Product Availability", "Error", JOptionPane.ERROR_MESSAGE);
        return;
    }
        double price = 0.0;
        int quantity = 0;
