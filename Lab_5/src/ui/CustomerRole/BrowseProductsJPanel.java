...
//        populateCartTable();
        ...
        try {
            ...
            JOptionPane.showMessageDialog(this, "Please enter a valid sales price and quantity.");
            return;
        }
        // Rest of your code...
        if (salesPrice < product.getPrice()) {
            JOptionPane.showMessageDialog(this, "Price should be more than or equal to the product's price.");
            return;
        }
        ...
        if (item == null) {
            if (product.getAvail() >= quant) {
                currentOrder.addNewOrderItem(product, salesPrice, quant); // Use the parsed salesPrice
                product.setAvail(product.getAvail() - quant);
            } else {
                JOptionPane.showMessageDialog(this, "Please check product availability.");
                return;
