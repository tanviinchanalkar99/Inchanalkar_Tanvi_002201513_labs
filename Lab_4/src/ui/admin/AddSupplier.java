...
public class AddSupplier extends javax.swing.JPanel {
    ...
    private void initComponents() {
        ...
        txtDescTextArea = new javax.swing.JTextArea();
        ...
        txtDescTextArea.setColumns(20);
        txtDescTextArea.setRows(5);
        jScrollPane1.setViewportView(txtDescTextArea);
    ...
    private void btnAddSupplierActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnAddSupplierActionPerformed
        ...
        if (txtName.getText().isEmpty() || txtDescTextArea.getText().isEmpty() || logoImage == null) {
            JOptionPane.showMessageDialog(this, "Please fill in all the fields and attach a logo.", "Error", JOptionPane.ERROR_MESSAGE);
        } else {
        Supplier supplier = supplierDirectory.addSupplier();
        supplier.setSupplyName(txtName.getText());
        supplier.setDescription(txtDescTextArea.getText());
    ...
    private javax.swing.JTextArea txtDescTextArea;
