...
public class ViewProductDetailJPanel extends javax.swing.JPanel {
    ...
    public ViewProductDetailJPanel(JPanel workArea, Product product) {
        ...
        if (product.getProductImage() != null) {
            imgProduct.setIcon(product.getProductImage());
        } else {
    ...
    private void btnSaveActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnSaveActionPerformed
        ...
        JOptionPane.showMessageDialog(this, "Product Information is saved", "Information", JOptionPane.INFORMATION_MESSAGE);
        refreshTable();
    ...
    public void updateProductDetails(Product product) {
        this.product = product;
        // Update your table and other fields with the product details here
